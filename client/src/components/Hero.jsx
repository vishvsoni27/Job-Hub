    ...
    return ( 
        <div className='container 2xl:px-20 my-10 mx-auto'>
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
                ...
                <div className='max-w-xl flex items-center justify-between bg-white rounded text-gray-600 pl-4 mx-4 sm:mx-auto'>
            ...
            <div className='border border-gray-300 shadow-md mt-5 mx-2 p-6 rounded flex'>
