...
const JobListing = () => {
    ...
    return (<div className='container 2xl:px-20 mx-auto flex flex-col max-lg:space-y-8 lg:flex-row py-8'>
        {/* sidebar */}
        <div className='w-full lg:w-1/4 bg-white px-4'>
            ...
            <button onClick={e => setShowFilter(prev => !prev)} className='px-6 py-1.5 border border-gray-400 rounded lg:hidden'>
